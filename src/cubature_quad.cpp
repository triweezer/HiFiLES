...
int cubature_quad::get_n_pts(void) { return n_pts; }

// method to get r location of cubature point

double cubature_quad::get_r(int in_pos) { return locs(in_pos, 0); }

// method to get s location of cubature point

double cubature_quad::get_s(int in_pos) { return locs(in_pos, 1); }

// method to get weight location of cubature point

double cubature_quad::get_weight(int in_pos) { return weights(in_pos); }
