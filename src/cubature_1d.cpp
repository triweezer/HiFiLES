...
int cubature_1d::get_n_pts(void) { return n_pts; }

// method to get r location of cubature_1d point

double cubature_1d::get_r(int in_pos) { return locs(in_pos); }

// method to get weight location of cubature_1d point

double cubature_1d::get_weight(int in_pos) { return weights(in_pos); }
