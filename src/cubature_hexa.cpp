...
cubature_hexa::cubature_hexa(int in_rule)  // set by rule
{
  ...
  char *f;
  std::string filename, param_name, param, ord;
...
int cubature_hexa::get_n_pts(void) { return n_pts; }

// method to get r location of cubature point

double cubature_hexa::get_r(int in_pos) { return locs(in_pos, 0); }

// method to get s location of cubature point
double cubature_hexa::get_s(int in_pos) { return locs(in_pos, 1); }

// method to get s location of cubature point
double cubature_hexa::get_t(int in_pos) { return locs(in_pos, 2); }

// method to get weight location of cubature point

double cubature_hexa::get_weight(int in_pos) { return weights(in_pos); }
