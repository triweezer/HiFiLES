...
class eles_quads : public eles {
 public:
  ...
  /*! set location of 1d solution points in standard interval (required for
  ...
  /*! Compute the number of 1d spts given a number of 2d spts for tensor product
   * shapes */
  ...
  /*! setup the concentration array required for concentration method for shock
   * capturing */
 ...
 protected:
  ...
  /*! location of solution points in standard interval (tensor product elements
   * only)*/
